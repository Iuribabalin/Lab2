...
public class Main_fun {
    public double f(double x){return Math.pow(x,3) + 2.84*Math.pow(x,2) - 5.606*x - 14.766;}
    public double f_(double x){return 3*Math.pow(x,2) + 5.68*x - 5.606;}
    public double f__(double x){return 6*x+5.68;}
